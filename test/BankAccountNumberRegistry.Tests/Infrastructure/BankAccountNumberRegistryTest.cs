namespace BankAccountNumberRegistry.Tests.Infrastructure
{
    ...
    using BankAccountNumberRegistry.Infrastructure.Modules;
    using KellermanSoftware.CompareNetObjects;
    using Microsoft.Extensions.Configuration;
    using Newtonsoft.Json;
    using Xunit.Abstractions;

    public class BankAccountNumberRegistryTest : AutofacBasedTest
    {
        ...
        public BankAccountNumberRegistryTest(ITestOutputHelper testOutputHelper) : base(testOutputHelper)
        {
