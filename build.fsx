...
Target "Restore_Solution" (fun _ -> restore "BankAccountNumberRegistry")

Target "Build_Solution" (fun _ -> build "BankAccountNumberRegistry")

Target "Test_Solution" (fun _ -> test "BankAccountNumberRegistry")
...
Target "Containerize_Projector" (fun _ -> containerize "BankAccountNumberRegistry.Projector" "projector")
