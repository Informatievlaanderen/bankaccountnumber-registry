namespace BankAccountNumberRegistry
{
    ...
    public struct ValidTo : IEquatable<ValidTo>, IComparable<ValidTo>
    {
        ...
        public ValidTo(DateTime? dateTime) => DateTime = dateTime;

        public ValidTo(int year, int month, int day) => DateTime = new DateTime(year, month, day);

        public static implicit operator DateTime? (ValidTo validTo) => validTo.DateTime;
